...
if __name__ == '__main__':
    ...
    # predict = GradientBoostingClassifier(n_estimators=100, random_state=5)
    predict = RandomForestClassifier(n_estimators=200, random_state=5)
    ...
    Data_writer.write_data_without_index(res_data, 'submissionRandomForest.csv', columns=('Label',),index_name='ImageId')
    # Data_writer.write_data_without_index(res_data, 'submissionGradientBoosting.csv', columns=('Label',),index_name='ImageId')