...
test_df   = pd.read_csv('../DataSet/TalkingData/test.csv', dtype=dtypes)
train_df  = pd.read_csv('../DataSet/TalkingData/train.csv', dtype=dtypes,nrows=200000)
...
submit_df[['click_id', 'is_attributed']].to_csv('subnew.csv', index=False)
print ('All done..')